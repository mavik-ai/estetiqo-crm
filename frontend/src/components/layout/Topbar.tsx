            ...
            <div className="flex items-center gap-3">
                ...
                <div ref={ref} style={{ position: "relative" }}>
                    <button
                        ...
                        style={{ background: open ? "#F5EDE0" : "#FFFFFF", border: "1px solid #EDE5D3" }}
                    ...
                    {open && (
                        ...
                        >
                            {/* Cabeçalho */}
                            <div style={{ padding: "14px 16px 10px", borderBottom: "1px solid #F5EDE0", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                <span style={{ fontSize: "13px", fontWeight: 700, color: "#2D2319" }}>Confirmações pendentes</span>
                                {notificationCount > 0 && (
                            ...
                            <div style={{ maxHeight: "300px", overflowY: "auto" }}>
                                {pendingAppointments.length === 0 ? (
                                    <div style={{ padding: "28px 16px", textAlign: "center" }}>
                                        ...
                                        <p style={{ fontSize: "13px", color: "#A69060", margin: 0 }}>Tudo em dia! Sem pendências.</p>
                                    </div>
                                ) : (
                                    pendingAppointments.map((appt) => (
                                        ...
                                        >
                                            <div
                                                style={{ padding: "12px 16px", borderBottom: "1px solid #F5EDE0", transition: "background 0.1s" }}
                                                onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.background = "#FBF5EA"; }}
                                                onMouseLeave={e => { (e.currentTarget as HTMLDivElement).style.background = "transparent"; }}
                                            >
                                                <div style={{ fontSize: "13px", fontWeight: 600, color: "#2D2319", marginBottom: "3px" }}>
                            ...
                            {/* Rodapé */}
                            {notificationCount > 0 && (
                                <div style={{ padding: "10px 16px", borderTop: "1px solid #F5EDE0" }}>
                                    <Link
                                        href="/rsvp"
                                        onClick={() => setOpen(false)}
