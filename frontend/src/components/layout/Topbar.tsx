        ...
        <div className="flex justify-between items-center px-6 py-4 flex-shrink-0" style={{ background: "#FEFCF7", borderBottom: "1px solid #EDE5D3" }}>
            ...
            <div className="flex items-center gap-3">
                <button
                    ...
                    style={{ background: "linear-gradient(135deg, #D4B86A, #B8960C)", color: "#FFFDF7", boxShadow: "0 3px 12px rgba(184,150,12,0.25)", fontSize: "12px", fontWeight: 700 }}
                >
                    <Plus size={15} strokeWidth={2.5} /> Novo agendamento
                </button>
                <div
                    className="relative w-10 h-10 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors"
                ...
                >
                    ...
                    {notificationCount > 0 && (
                        ...
                        >
                            <span className="text-white font-bold" style={{ fontSize: "9px" }}>{notificationCount}</span>
                        </div>
                    )}
                </div>
            </div>
